...
interface KidsWearProps {
    kidWears: IFrontProduct[]
}

export default function MensWear({ kidWears }: KidsWearProps) {
   
    return (
        <section className="py-16 px-4 md:px-6 bg-white dark:bg-gray-700">
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                          Explore our latest collection of stylish and comfortable kids's fashion.
                    </p>
                </div>
