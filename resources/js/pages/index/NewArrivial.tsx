            ...
            >
              ...
              <div className="p-3">
                ...
                <div className="flex gap-1">
                  ...
                  <button className="flex-1 inline-flex items-center justify-center text-xs font-bold border border-gray-200 bg-gray-50 text-gray-700 py-1.5 px-2 rounded-lg hover:bg-gray-100 transition-all">
