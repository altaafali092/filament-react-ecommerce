...
import { IFrontOfficeSetting, Order, PageProps } from '@/types/frontend';
...
export default function OrderDetailPage() {
    ...
    const cancelOrder = (order: Order) => {
        ...
        router.get(route('cancelOrder', order.id), {}, {
            preserveScroll: true,
            onSuccess: () => {
                // Optional: show a toast or message if you use shadcn/toast
        ...
        <div className="min-h-[80vh] px-4 py-10">
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                    ...
                    {order.status === "draft" && (
                        <Button variant="destructive" onClick={() => cancelOrder(order)}>
                            Cancel Order
                        </Button>
                    )}
